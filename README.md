***Github portfolio is a current work in progress. PowerBI, MS Excel, and additional SQL and Tableau projects coming soon...
...
Hey there! I'm Laura Buibas, a tech enthusiast living in New York 🗽. With a knack for turning data into insights and solutions, I'm on a mission to dive deep and uncover hidden data gems 💎! From SQL sorcery to Python wizardry, I've got the tools to sprinkle some magic into your data analytics to turn data into insights and ideas into action 🚀. When I'm not busy crunching numbers, you can find me whipping up culinary creations 🍳. Let's connect on [LinkedIn](https://www.linkedin.com/in/laura-buibas) and geek out over data together 😄.
